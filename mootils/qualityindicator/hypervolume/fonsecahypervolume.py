...
class FonsecaHyperVolume(QualityIndicator):
    """ Hypervolume computation based on variant 3 of the algorithm in the paper:
        C. M. Fonseca, L. Paquete, and M. Lopez-Ibanez. An improved dimension-sweep algorithm for the hypervolume
        indicator. In IEEE Congress on Evolutionary Computation, pages 1157-1163, Vancouver, Canada, July 2006.

        Minimization is implicitly assumed.

        Code based on the implementation of Simon Wessing
    """

    def __init__(self, reference_point: [float]):
        super(FonsecaHyperVolume, self).__init__()
    ...
    def get_name(self) -> str:
        return "Hypervolume proposed by Fonseca et al."
